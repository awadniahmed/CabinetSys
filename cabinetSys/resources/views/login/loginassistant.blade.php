...
<head>
  ...
  <!-- endinject -->
  <link rel="shortcut icon" src="{{asset('images/imgc.png')}}"  />
  <style >
        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <h4>Espace Assistant</h4>

              @if (session('status'))
              <div class="alert alert-danger">{{session('status')}}</div>
          @endif

              <form class="pt-3" method="POST" action="loginAssistant">
                @csrf
                ...
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="exampleInputPassword1" placeholder="Mot de passe " name="password" se connectez>
                </div>
                <div class="mt-3">
                ...
                <div class="text-center mt-4 fw-light">
                    <a href="/" class="text-primary">
                        Allez vers  un Compte docteur</a>
                    </div>
              </form>
            </div>
          </div>
