...
@section('content')
    ...
    <div class="content-wrapper">
        <div class="row">
          <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="card-title" style="color:blue" >Créer une Observation</h4>
                ...
                <form class="forms-sample" method="post" action="insertObservation">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
 ...
 <option value="{{$docteur->nom}}{{" "}}{{$docteur->prenom}}">{{$docteur->nom}}{{" "}}{{$docteur->prenom}}</option>
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" id="exampleInputConfirmPassword1" name="date_ad" required >
                  </div>
                  <div class="mb-3">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="note"></textarea>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                  <div class="form-group row">
                  <button type="submit" class="btn btn-primary me-2">Créer une observation</button>
                                  </div></div>
                                  <div class="col-md-6">
                                    <div class="form-group row">
                  <a href="{{route('listAllObservation')}}"><button type="button" class="btn btn-success"> Afficher la  Liste des Ovservations</button></a>
                                    </div></div></div>
                </form>
              </div>
            </div>
